...
class Doctor {
  ...
  String emailAddress;
  String age;
  List<AppointmentD> applicationLeft;
...
class AppointmentD {
  ...
  factory AppointmentD.fromJson(Map<String, dynamic> json) {
    return AppointmentD(
      id: json['_id'],
      userId: json['userId'],
      appointMentDetails: (json['appointMentDetails'] as List)
          .map((al) => AppointmentDetailsD.fromJson(al))
          .toList(),
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      '_id': id,
      'userId': userId,
      'appointMentDetails': appointMentDetails.map((al) => al.toMap()).toList(),
    };
  }
...
class AppointmentDetailsD {
  ...
  factory AppointmentDetailsD.fromJson(Map<String, dynamic> json) {
    return AppointmentDetailsD(
      date: json['date'],
