...
class AppointmentHistoryCardUser extends StatefulWidget {
  ...
  @override
  State<AppointmentHistoryCardUser> createState() =>
      _AppointmentHistoryCardUserState();
}

class _AppointmentHistoryCardUserState
    extends State<AppointmentHistoryCardUser> {
  @override
  void initState() {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 8.0),
                  if (widget.appointment.rating != null &&
                      double.parse(widget.appointment.rating!) < 3)
                    TextButton.icon(
                        onPressed: () {
                        ...
                        label: Text(
                            "Conatct with Doctor ${state is setMessageCountUpdateUserSuccess ? state.messageCountSee : "0"}")),
                  SizedBox(height: 8.0),
